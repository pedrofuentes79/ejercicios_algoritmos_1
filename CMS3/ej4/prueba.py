...
def avanzarFila(fila: Queue, min: int):
  ...
  while curr <= min:
    ...
    if curr % 4 == 0:
      print("LLEGA ALGUIEN NUEVO A LA FILA")
      cantidad_personas += 1
    ...
    print("fila: ", list(fila.queue))
    print("Caminando: ", caminando)
    ...
    #FILA Y CAJASPOST ATENDER
    print("fila post atender: ", list(fila.queue))
    print("Caja 1: ", caja1)
    print("Caja 2: ", caja2)
    print("Caja 3: ", caja3)
